...
import spainFlag from "../../assets/icons/spain-country-flag-round-icon.svg"; // Imagem da Espanha
import ukFlag from "../../assets/icons/uk-flag-round-circle-icon.svg"; // Imagem do Reino Unido
import "../../assets/styles/navbar.css"; // Estilo personalizado (adicione o arquivo CSS)
