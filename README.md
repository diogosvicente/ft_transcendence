...
Este projeto faz parte do currículo da École 42 e tem como objetivo o desenvolvimento de uma aplicação web multiplayer de Pong, com funcionalidades adicionais de chat, autenticação e suporte a jogadores remotos.
